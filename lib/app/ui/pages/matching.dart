...
import 'package:fido/app/controller/match.dart';
import 'package:fido/app/ui/themes/font_size.dart';
import 'package:fido/app/ui/widgets/swip_stack.dart';
                    ...
                    Obx(() => Container(
                        ...
                        child: MatchingController.to.usersEmpty == true
                            ? Align(
                                ...
                                child: Column(
                                  ...
                                  children: <Widget>[
                                    ...
                                    CommonText(
                                        text: "There's no one new around you.",
                            ...
                            : SwipeStack(
                                ...
                                children: [
                                  SwiperItem(builder: (SwiperPosition position,
                                      double progress) {
                                    return Material(
                                      elevation: 5,
